...
const styles = StyleSheet.create({
  ...
  botaoCompartilhar: {
    backgroundColor: "#FFFFF0", // Cor de fundo do botão de compartilhamento
  ...
  textoBotaoCompartilhar: {
    color: "black", // Cor do texto do botão de compartilhamento
